...
export function PlaybackBar({
  ...
  return (
    <div className="min-w-0 border-t border-white/5 bg-ink-900 px-3 pt-3 pb-3 sm:px-5 sm:pb-4">
      {/* timeline */}
      ...
      {/* controls */}
      <div className="mt-2.5 flex items-center gap-x-3 gap-y-2.5 overflow-x-auto pb-1 lg:flex-wrap lg:overflow-visible lg:pb-0">
